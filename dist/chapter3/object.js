...
let f;
f = {}; // error TS2741: '{}' 타입에는 '{b: number}' 타입에 대한 'b' 프로퍼티가 없음
f = {
    b: 1,
    c: 2 // error TS2322: 
...
g = { 10: true }; // error TS2741, 'b' 프로퍼티가 없음
g = { b: 1, 33: 'red' }; // error TS2322: 'string' 타입은 'boolean' 타입에 할당할 수 없음
let user = {
    fristName: 'abby'
};
user.fristName;
user.fristName = 'abbey with an e'; // error TS2540, 'firstName'은 읽기 전용 프로퍼티이므로 할당할 수 없음
